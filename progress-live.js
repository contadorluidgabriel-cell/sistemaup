(()=>{
  const loadSeriesPrescription=()=>{
    if(window.SistemaSeriesPrescription||document.querySelector('script[data-series-prescription-loader]'))return;
    const script=document.createElement('script');
    script.src='series-prescription.js';
    script.dataset.seriesPrescriptionLoader='true';
    script.defer=true;
